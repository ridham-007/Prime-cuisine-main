  ...
  return (
    <>
      <form className="container mx-auto flex flex-col justify-center px-32 mb-36">
          ...
          <div className="flex flex-col justify-center md:items-center my-4">
            ...
            <div className="lg:w-[32rem] text-center relative">
              <div className="relative">
                <input
                  className="border-none focus:outline-none text-sm pl-6 h-12 w-[80%] bg-[#fafafa]/[0.5] border-transparent rounded-lg "
        ...
        <button type="submit" className="animated-btn px-[6rem] mx-auto py-[0.9rem] bg-brnadColor  rounded-[5px] flex" >
          Update Password
        </button>
      </form>
    </>
